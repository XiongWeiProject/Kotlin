...
import com.example.myapplication.adpter.RecommendListAdapter
...
class HomeFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        refresh_recommend = view.findViewById(R.id.sf_refresh)
        rv_list_recommend = view.findViewById(R.id.text_home)
        return view
    }
